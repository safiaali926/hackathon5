  ...
  return (
    <>
     ...
     <div className="max-w-xl w-full ">
       <h1 className="text-[#151875] font-bold text-2xl ">Shop Grid Default</h1>
       <p>
    ...
    <section className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-center text-3xl font-bold text-blue-900 mb-8">Our Products</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {products.map((product) => (
          <div key={product.id} className="text-center">
            {/* Image container */}
            <div className="bg-gray-100 rounded-md p-4" style={{ height: "200px" }}>
              <img
                src={product.imgSrc}
                alt={product.title}
            ...
            {/* Content outside of box */}
            <div className="mt-4">
              <h2 className="text-md font-semibold text-[#151875]">{product.title}</h2>
              <p className="text-md font-bold text-[#151875]">{product.price}<span className="line-through text-pink-500 px-2">$42.00</span></p>
